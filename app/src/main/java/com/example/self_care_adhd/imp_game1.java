...
public class imp_game1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imp_game1);
        ...
        stop_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_stop = new Intent(imp_game1.this, MainActivity.class);
        ...
        next_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check_radio == 1){
                    ...
                    Intent intent_nextO = new Intent(imp_game1.this, imp_game2.class);
                    startActivity(intent_nextO);
                }else{
                    Toast.makeText(getApplicationContext(), "오답입니다.", Toast.LENGTH_LONG).show();
                    Intent intent_nextX = new Intent(imp_game1.this, imp_game2.class);
