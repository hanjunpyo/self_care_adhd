...
public class imp_game9 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imp_game9);
        ...
        stop_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_stop = new Intent(imp_game9.this, MainActivity.class);
        ...
        next_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_next = new Intent(imp_game9.this, imp_game10.class);
