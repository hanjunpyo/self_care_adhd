...
public class con_degree_12 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.con_degree_12);
        ...
        next_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check_radio == 1){
                    ...
                    Intent intent_next = new Intent(con_degree_12.this, con_degree_1.class);
                    intent_next.putExtra("get_o", get_o);
                    startActivity(intent_next);
                }else{
                    Toast.makeText(getApplicationContext(), "오답입니다.", Toast.LENGTH_LONG).show();
                    Intent intent_next_1 = new Intent(con_degree_12.this, con_degree_1.class);
                    intent_next_1.putExtra("get_o", get_o);
