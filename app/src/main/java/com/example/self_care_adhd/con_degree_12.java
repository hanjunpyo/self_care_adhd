...
public class con_degree_12 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        random_d12 = new Random();
        randomValue_d12 = random_d12.nextInt(11);

        //쉐어드 프리퍼런스 초기화
        pref_d1 = getSharedPreferences("con_d1", MODE_PRIVATE);
        editor_d1 = pref_d1.edit();
        check_answer_d12 = pref_d1.getInt("con_d1_c", 0);
        check_step_d12 = pref_d1.getInt("con_d1_step", 0);
        ...
        next_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                editor_d1.putInt("con_d1_c", check_answer_d12 + 1);
                Intent intent_next = new Intent(con_degree_12.this, con_degree_13.class);
