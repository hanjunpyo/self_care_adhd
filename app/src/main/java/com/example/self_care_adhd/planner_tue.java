...
public class planner_tue extends AppCompatActivity {
    ...
    RadioGroup alarm_check_tue;
    int check_radio_tue = 1;
    TextView test1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //라디오그룹 불러오기
        alarm_check_tue = (RadioGroup)findViewById(R.id.alarm_check_tue);
        test1 = findViewById(R.id.test1);
        //라디오 체크 확인
        alarm_check_tue.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.alarm_y_tue){
                    check_radio_tue = 1;
                }else if(checkedId == R.id.alarm_n_tue){
                    check_radio_tue = 2;
                }else{
                    check_radio_tue = 3;
                }
