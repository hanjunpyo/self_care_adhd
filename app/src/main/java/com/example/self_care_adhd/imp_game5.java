...
public class imp_game5 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imp_game5);
        ...
        stop_game.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_stop = new Intent(imp_game5.this, MainActivity.class);
        ...
        next_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_next = new Intent(imp_game5.this, imp_game6.class);
