...
public class con_degree_211 extends AppCompatActivity {
    //다음 버튼
    LinearLayout next_q;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.con_degree_211);
